...
SYMBOLS['right box'] = Events('text->]')
SYMBOLS['left box'] = Events('text->[')
...
ALPHABET['lake'] = Events('key->key=l')
ALPHABET['mike'] = Events('key->key=m')
ALPHABET['nano'] = Events('key->key=n')
ALPHABET['oscar'] = Events('key->key=o')
ALPHABET['pope'] = Events('key->key=p')
...
ALPHABET['yukon'] = Events('key->key=u')
...
CASE_ALPHABET['case lake'] = Events('key->key=l&modifier=shift')
CASE_ALPHABET['case mike'] = Events('key->key=m&modifier=shift')
CASE_ALPHABET['case nano'] = Events('key->key=n&modifier=shift')
CASE_ALPHABET['case oscar'] = Events('key->key=o&modifier=shift')
CASE_ALPHABET['case pope'] = Events('key->key=p&modifier=shift')
...
CASE_ALPHABET['case yukon'] = Events('key->key=u&modifier=shift')
